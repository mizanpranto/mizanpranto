...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=650&lines=Ethical+Hacker+%E2%86%92+Cybersecurity+Consultant;AI+%26+Cybersecurity+Consultant+%40+HSA+Group;Pentest+Team+Lead;CEH+%7C+SSCP+%7C+ISO+27001+Lead+Auditor" alt="Typing SVG" />
...
Today I'm an **AI & Cybersecurity Consultant** at **HSA Group**, leading a penetration testing team and advising on security architecture, threat modeling, and AI-driven vulnerability analysis. Before that, I ran enterprise-wide cybersecurity strategy as **Cybersecurity Lead & Program Director** at SMP CyberSecurity Ltd., delivering ISO/IEC 27001-aligned governance programs to government and private-sector clients, and trained 4,000+ learners in ethical hacking, network defense, and secure development.
...
📍 Mymensingh, Bangladesh · 🎓 CEH · SSCP · ISO/IEC 27001 Lead Auditor
...
Security assessments using static analysis and CWE/MITRE classification; risk reports and remediation guidance aligned with ISO/IEC 27001 and NIST CSF; AI-driven vulnerability analysis.
...
![CEH](https://img.shields.io/badge/EC--Council-CEH-1BA0D7?style=flat-square)
...
### 🔍 S3 Exposure Scanner
Scans AWS S3 buckets for public access, missing encryption, logging gaps, and versioning issues.

`Python`

[**→ View Repo**](https://github.com/mizanpranto/s3-exposure-scanner)
...
### 🧱 SecArch Lab
Security architecture reference and experimentation lab.

`HTML`

[**→ View Repo**](https://github.com/mizanpranto/secarch-lab)
...
Open to pentesting, security consulting, and AI-security research conversations.
...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=26&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=650&lines=CloudSecurity+%26+Cybersecurity+Consultant;AWS+Certified;Cloud+Security+%7C+IAM+%7C+S3+%7C+CIS;I+Find+What+Auditors+Miss" alt="Typing SVG" />
...
Automated checks against 50 controls from the AWS CIS Foundations Benchmark.

`Python` `Compliance` · **Demo mode included — no AWS creds needed**
...
Looking for an AWS security assessment, S3 exposure audit, or IAM review?
